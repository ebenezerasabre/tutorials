...
def rev_dups(a_string):
	seen = {}
	str = ""
	#words = a_string.split()
	words = re.split(r'[ ,\.]+', a_string)
	for word in words:
		if word in seen:
			seen[word] += 1
		else:
...
print(rev_dups(a_string))



nums1 = [1,1,1,2,2,3,4,5,3,4,7,9,8,7]
...
print("starting rms2")
#2 they say it's correct but i dont trust it
def rms2(nums):
	j = 1
